...
His research is supported by grants from the NSF (including an [NSF CAREER award](https://nsf.gov/awardsearch/showAward?AWD_ID=1847393)), [AFOSR Information and Networks Program](https://www.afrl.af.mil/About-Us/Fact-Sheets/Fact-Sheet-Display/Article/2282109/afosr-information-and-networks/), the ARO MURI Program, the [ARL Network Sciences](https://www.arl.army.mil/www/default.cfm?page=520) division, and [Engaged Cornell](https://engaged.cornell.edu/). His work has received several awards, including the [Erlang Prize](https://www.informs.org/Recognizing-Excellence/Community-Prizes/Applied-Probability/Erlang-Prize), the 2021 INFORMS [APS Best Publication Award](https://connect.informs.org/aps/apsawards/bestpub-past), and the 2026 [SIGMETRICS Best Paper Award](https://www.sigmetrics.org/awards.shtml#paperawards).
